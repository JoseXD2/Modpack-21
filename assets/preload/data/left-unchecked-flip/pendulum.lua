...
function onCreatePost()
	-- end of "create"
	makeAnimatedLuaSprite('pendelum', 'hypno/Pendelum_Phase2', 0, 0);
	...
	makeAnimatedLuaSprite('tranceThing', 'hypno/StaticHypno', 0, 0);
	...
	if active then 
		...
		if trance < tranceMin then
			trance = tranceMin
                ...
                if (getMouseX('camHUD') > 0 and getMouseX('camHUD') < 132) and (getMouseY('camHUD') > 588 and getMouseY('camHUD') < 720 and mouseClicked('left')) or keyJustPressed('space') then
...
function win()
	...
	makeAnimatedLuaSprite(shadName, 'hypno/Pendelum_Phase2', xpos, ypos);
