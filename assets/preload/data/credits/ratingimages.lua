...
function onCreatePost()
	if not lowQuality then
		...
		-- not made by me (said by NotAn127)
	...
	precacheImage('CreditsSong/shit');
	precacheImage('CreditsSong/bad');
	precacheImage('CreditsSong/good');
	precacheImage('CreditsSong/sick');

	-- TODO: replace ratings (This is how you do it)
end	
...
function goodNoteHit(id, direction, noteType, isSustainNote)
	...
	if not isSustainNote and resetHideHud then
		...
		makeLuaSprite('lastRating', 'CreditsSong/' .. rating, screenWidth * 0.35 - 75 - middlescrolloffset, screenHeight / 2 - 60);
