function onCreatePost()
	--if difficulty == 1 then
		...
		makeAnimatedLuaSprite('Left', 'pixelSplashes', 0, -45)
		else
		makeAnimatedLuaSprite('Left', 'pixelSplashes', 0, 480)
		end
		...
		if not getPropertyFromClass('ClientPrefs', 'downScroll', true) then
		makeAnimatedLuaSprite('Down', 'pixelSplashes', 100, -45)
		else
		makeAnimatedLuaSprite('Down', 'pixelSplashes', 100, 480)
		end
		...
		if not getPropertyFromClass('ClientPrefs', 'downScroll', true) then
		if not getPropertyFromClass('ClientPrefs', 'middleScroll', true) then
		makeAnimatedLuaSprite('Up', 'pixelSplashes', 215, -45)
		else
		makeAnimatedLuaSprite('Up', 'pixelSplashes', 860, -45)
		end
		else
		if not getPropertyFromClass('ClientPrefs', 'middleScroll', true) then
		makeAnimatedLuaSprite('Up', 'pixelSplashes', 215, 480)
		else
		makeAnimatedLuaSprite('Up', 'pixelSplashes', 860, 480)
		end
		end
		...
		if not getPropertyFromClass('ClientPrefs', 'downScroll', true) then
			if not getPropertyFromClass('ClientPrefs', 'middleScroll', true) then
				makeAnimatedLuaSprite('Right', 'pixelSplashes', 330, -45)
			else
				makeAnimatedLuaSprite('Right', 'pixelSplashes', 975, -45)
			end
		else
			if not getPropertyFromClass('ClientPrefs', 'middleScroll', true) then
				makeAnimatedLuaSprite('Right', 'pixelSplashes', 330, 480)
			else
				makeAnimatedLuaSprite('Right', 'pixelSplashes', 975, 480)
			end
		end
		if not getPropertyFromClass('ClientPrefs', 'middleScroll', true) then
