...
function onStartCountdown()
	precacheImage('applecore/monkey_guy')
	precacheImage('applecore/monkey_person')
	precacheSound('suck')
...
function onBeatHit()
	if curBeat == 192 then
		...
		followchars = true
		doTweenAngle('minionspin', 'applecore/minion', 20250, 150)
		doTweenAngle('minion2spin', 'applecore/minion2', 20250, 150)
		setProperty('poopsky.visible', true)
		setProperty('pizza.visible', false)
		setProperty('pizza2.visible', false)
	end
	if curBeat == 200 then
		doTweenY('bambidescend', 'applecore/bambi', -100, 1, 'circOut')
	...
	if curBeat == 522 then
		...
		makeLuaSprite('monkeboy', 'applecore/monkey_guy', xx, 100)
		addLuaSprite('monkeboy', true)
		cancelTween('bandu1')
		cancelTween('bandu2')
		removeLuaSprite('bambi')
		makeLuaSprite('monkeman', 'applecore/monkey_person', -200, 0)
