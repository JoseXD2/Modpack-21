...
function onBeatHit()
	if curBeat >= 388 and not haha then
		...
		doTweenColor("coloUH", "3dFuckedc", "FFFFFF", 0.5, "sineInOut")
	...
	if curBeat >= 392 and haha and not hehe then
		...
		doTweenColor("colorLOL", "3dFuckedc", "000000", 10, "linear")
		hehe = true
	end
	if math.fmod(curBeat,16) == 4 and not poopoo then
		doTweenColor("colorA", "dad", "ff0000", 0.5, "sineInOut")
		doTweenColor("iconA", "iconP2", "ff0000", 0.5, "sineInOut")
		doTweenColor("colorB", "3dFuckedc", "ff0000", 0.5, "sineInOut")
		doTweenAngle("cameraA", "camHUD", 540, 0.5, "expoInOut")
	end
	if math.fmod(curBeat,16) == 8 and not poopoo then
		doTweenColor("colorC", "dad", "00ff00", 0.5, "sineInOut")
		doTweenColor("iconB", "iconP2", "00ff00", 0.5, "sineInOut")
		doTweenColor("colorD", "3dFuckedc", "00ff00", 0.5, "sineInOut")
...
function onCreate()
	...
	doTweenColor("thenew", "dad", "FFFFFF", 0.01, "linear")
	doTweenColor("thewhat??", "iconP2", "FFFFFF", 0.01, "linear")
	doTweenColor("theold", "3dFuckedc", "FFFFFF", 0.01, "linear")
