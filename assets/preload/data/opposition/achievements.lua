...
function onCreate()
         makeLuaSprite('win', 'achievements/oppositiona', 0, 0)  --your achiviement image
         ...
         makeLuaText('text', 'RED HELL', 200, 120, 10) -- change your title text
         setTextSize('text', '25') --text size 
         setTextColor('text', 'ff0000') --change color in hex
         setObjectCamera('text', 'other')
         setProperty('text.alpha', 0)
         addLuaText('text', true)

         makeLuaText('text2', 'You Beat |Opposition|', 200, 120, 40) -- change your description text
...
function onEndSong() --idk how to make it work if story mode played sorry ;-;
