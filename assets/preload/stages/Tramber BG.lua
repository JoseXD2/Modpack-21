function onCreate()
	...
	makeLuaSprite('Tramber BG', 'bundix/Tramber BG', -1000, -600);
	setLuaSpriteScrollFactor('Tramber BG', 0.9, 0.9);
	addLuaSprite('Tramber BG', false)
	scaleObject('Tramber BG', 3.2, 3.2)
	addGlitchEffect('Tramber BG', 2, 2)
end
