function onCreate()
	...
	makeLuaSprite('Trambge BG', 'bundix/Trambge BG', -700, -900);
	setLuaSpriteScrollFactor('Trambge BG', 0.9, 0.9);
	addLuaSprite('Trambge BG', false)
	scaleObject('Trambge BG', 4, 4)
	addGlitchEffect('Trambge BG', 2, 2)
end
